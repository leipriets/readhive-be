...
LikeComments.belongsTo(Comment, {
  foreignKey: "comment_id",
  as: "like_comments",
});

Notification.hasMany(NotificationActors, {
  foreignKey: "notification_id",
  as: "notification_actors",
});
Notification.belongsTo(User, { foreignKey: "user_id", as: "sender" });

NotificationActors.belongsTo(Notification, {
  foreignKey: "notification_id",
  as: "notification_actors",
});
